        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-center" id="navbarSupportedContent">
                <ul class="nav nav-underline navbar-nav mx-auto mb-2 mb-lg-0 justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../super-admin/sa-rfa-entries.php"
                            id="rfaLink" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="click"
                            data-bs-title="<strong>New Entries</strong>" data-bs-content="Assignment"
                            data-bs-placement="bottom">RFA</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href=" ../super-admin/sa-sena-records.php" id="recordsLink"
        ...
        <div class="container">
            <div class="row justify-content-between mb-2" style="padding-top: 4%">
                <div class="col ml-auto">
                    <h4 class="fw-bold mt-3" style="font-family: sub-font-bold; color: #304DA5;"><a
                            href="../super-admin/sa-dashboard.php" class="fw-bold mt-5"
            ...
            <table class="table table-bordered"
                style="border: 2.5px solid #304DA5; table-layout: fixed; border-radius: 3px; ">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="d-flex align-items-center justify-content-center"><a
                                href="sa-rfa-assignment.php"><button class="btn btn-dark"
                                    style="width:55px; height: 45px; background-color: #304DA5"><img
                                        src="../assets/Done.svg"></button>
                            </a>
                        </td>
                    </tr>
                    <tr>
