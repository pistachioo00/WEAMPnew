...
<body>
    <nav class="navbar navbar-expand-lg sticky-top"
        style="background-color: #C80000; position: fixed; width: 100%; z-index: 999;">
        <div class="container">
            <a class="navbar-brand" href="../admin/home.php">
                <img src="../assets/WAO-Logo.svg" alt="Header-Title" class="img-fluid"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#" id="rfaLink" data-bs-toggle="popover"
                            data-bs-html="true" data-bs-trigger="click" data-bs-title-center="RFA"
                            data-bs-content='<div><a class="nav-link text-black" href="rfa-entries.php" class="btn btn-link">New Entries</a><br><a class="nav-link text-black" href="rfa-assignment.php" class="btn btn-link">Assignment</a></div>'
                            data-bs-placement="bottom">
                            RFA
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#" id="recordsLink" data-bs-toggle="popover"
                            data-bs-html="true" data-bs-trigger="click" data-bs-title-center="Records"
                            data-bs-content='<div><a class="nav-link text-black" href="sena-records.php" class="btn btn-link">SENA Conferences</a><br><a class="nav-link text-black" href="#" class="btn btn-link">Advice Counselling</a></div>'
                            data-bs-placement="bottom">
                            Records
                        </a>
                    </li>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border rounded shadow" style="border: 1px solid #ddd;">
                <div class="modal-header" style="background-color: #140c3e; color: #eee203;">
                    <h5 class="modal-title text-center" id="logoutConfirmationModalLabel"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        style="background-color: #C80000; color: white; border-radius: 30px;">
                        Cancel
                    </button>
                    <button type="button" class="btn btn-primary" onclick="logout()"
                        style="background-color: #140c3e; color: #eee203; border-radius: 30px;">
                        Logout
                    </button>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-3">
                    <div class="searchbar-rec">
                        ...
                        <input type="text" name="claimsIssues" class="form-control"
                            style="background-color: #E5EEFF; border: 1px solid black; border-radius: 10px"
                            value="<?php echo isset($_GET['claimsIssues']) ? htmlspecialchars($_GET['claimsIssues']) : ''; ?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="searchbar-rec">
                        <div class="label">Relief Prayed</div>
                        <input type="text" name="reliefPrayed" class="form-control"
                            style="background-color: #E5EEFF; border: 1px solid black; border-radius: 10px"
                            value="<?php echo isset($_GET['reliefPrayed']) ? htmlspecialchars($_GET['reliefPrayed']) : ''; ?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="searchbar-rec">
                        ...
                        <div class="input-with-icon">
                            <input type="date" name="dateCreated" class="form-control"
                                style="background-color: #E5EEFF; border: 1px solid black; border-radius: 10px"
                                value="<?php echo isset($_GET['dateCreated']) ? htmlspecialchars($_GET['dateCreated']) : ''; ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-2 mt-3">
                    <div class="searchbar-rec">
                        <button type="submit" class="btn btn-dark btn-block button fw-bold btn-hover"
                            style="font-family: Arial; height: 4%; font-size: .83rem; background-color: black">SEARCH</button>
                    </div>
                </div>
            </div>
        </form>
        ...
        <table class="table-sena-records" style="padding-bottom: 20%;">
            ...
            <tbody>
                ...
                <tr style="background-color:#E5EEFF">
                    ...
                    <td> SEAD RCMD
                        NCR-VAL-<?php echo htmlspecialchars(string: $record['referenceID']); ?>-<?php echo date_format(date_create(htmlspecialchars($record['dateCreated'])), 'm-Y'); ?>
                    </td>
                    <td><?php echo htmlspecialchars($record['claimsAndIssues']); ?></td>
                    ...
                    <td>
                        <div class="button-container">
                            <a href="sena-details.php"><button class="button col-auto"><img
                            ...
                            <button class="button col-auto" data-bs-toggle="modal" data-bs-target="#exampleModal"><img
                                    src="../assets/trash.svg" alt=""></button>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
