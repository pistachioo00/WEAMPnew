...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-center" id="navbarSupportedContent">
                <ul class="nav nav-underline navbar-nav mx-auto mb-2 mb-lg-0 justify-content-center">
                    ...
                    <li class="nav-items">
                        <a class="nav-link active" aria-current="page" href="../super-admin/sa-sena-records.php">Records</a>
                    </li>
                    <div class="mr-5"></div>
                    <li>
    ...
    <div class="container" style="padding-top:3%">
        ...
        <h2 class="fw-bold text-end" style="font-family: Arial; color: black">SEAD RCMD-NCR-VAL-03-002-2024</h2>
        ...
        <div class="col-md-2 d-flex justify-content-start align-items-start">
            <a href="../super-admin/sa-sena-records.php"><button class="btn btn-dark fw-bold mb-5" style="font-size: 1rem; padding: 8px; border-radius: 50px">
