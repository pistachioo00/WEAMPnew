...
<body>
    ...
    <div class="container" style="padding-top:3%">
        ...
        <h2 class="fw-bold text-end" style="font-family: Arial; color: black">SEAD RCMD-NCR-VAL-03-001-2024</h2>
        ...
        <div class="col-md-2 d-flex justify-content-start align-items-start">
            <a href="../admin/sena-records.php"><button class="btn btn-dark fw-bold mb-5" style="font-size: 1rem; padding: 8px; border-radius: 50px">
