...
<body>
    ...
    <div class="container text-align-left" style="padding-top:8%">
        <a href="rfa-seado.php" class="mt-2 d-flex justify-content-start" style="padding-left: none;">
            <img src="../assets/Expand_left.svg" alt="Back-Button" style="width: 4rem; height: 4rem;">
        </a>
    </div>
    <div class="container">
        <h2 class="text-start" style="font-family: sub-font-bold; font-weight: bold; padding-top: 3%;">RFA ENTRY
        </h2>
        <div class="col-md-2 d-flex justify-content-center align-items-center">
            <select id="category" class="form-control" style="background-color: #212529; border: 1px black solid; color: white; text-align:center">
                <option value="">SEADO #1</option>
                <option value="" selected>SEADO #2</option>
                <option value="">SEADO #3</option>
                <option value="">SEADO #4</option>
                <option value="">SEADO #5</option>
            </select>
        </div><br>
        <div class="container">
            <table class="table">
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="padding-bottom: 4%">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                ...
                <tr>
                    ...
                    <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        ...
                        cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</td>
                </tr>
                <tr>
                    <td class="fw-bold fs-5" style="padding-top: 5%; padding-bottom: 5%">Relief Prayed For</td>
